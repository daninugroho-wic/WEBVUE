        ...
        <ul class="space-y-4 px-2">
          ...
          <li>
            <router-link to="/hak-akses"
              ...
              <svg class="w-8 h-8 text-green-500 group-hover:text-green-700 dark:group-hover:text-green-300" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                viewBox="0 0 24 24">
                <path d="M3 12l2-2m0 0l7-7 7 7M13 5v6h6" />
                <path d="M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0h6" />
...
<style scoped>
/* Optional: Customize your sidebar and content styles */
</style>
