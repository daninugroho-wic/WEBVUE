    ...
    <aside id="logo-sidebar" :class="[
      ...
      sidebarOpen ? 'translate-x-0' : '-translate-x-full',
        ...
        <div class="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
            ...
            <button @click="toggleSidebar" class="sm:hidden text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400" aria-label="Close sidebar">
        ...
        <nav class="mt-5">
            <ul class="space-y-4 px-2">
                ...
                <li>
                    <router-link to="/akses" class="flex justify-center items-center p-4 rounded-lg text-green-700 hover:bg-green-100 dark:text-green-300 dark:hover:bg-green-800 group" active-class="bg-green-200 dark:bg-green-900 font-semibold">
                        <svg class="w-8 h-8 text-green-500 group-hover:text-green-700 dark:group-hover:text-green-300" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                ...
                <li>
                    <router-link to="/laporan" class="flex justify-center items-center p-4 rounded-lg text-blue-700 hover:bg-blue-100 dark:text-blue-300 dark:hover:bg-blue-800 group" active-class="bg-blue-200 dark:bg-blue-900 font-semibold">
                        <svg class="w-8 h-8 text-blue-500 group-hover:text-blue-700 dark:group-hover:text-blue-300" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                            <path d="M3 12l2-2m0 0l7-7 7 7M13 5v6h6" />
                            <path d="M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0h6" />
                        </svg>
                    </router-link>
